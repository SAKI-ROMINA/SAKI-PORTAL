...
const enviarNotificacionPrendaEstado = async ({
  ...
  try {
    ...
    if (!accessToken) {
      console.warn("No hay sesión para enviar la notificación de estado de prenda.");
      return;
    }
...
await enviarNotificacionPrendaEstado({
  ...
  `,
    ...
    console.error("Error guardando rectificación:", error);
    alert("No se pudo guardar la rectificación.");
  } finally {
