        ...
        <main style={mainPanelStyle}>
          ...
          <section style={searchCardStyle}>
            <div style={searchHeaderStyle}>
              ...
              <div style={resultBadgeStyle}>8 informes</div>
            </div>
          ...
          <section style={tableCardStyle}>
            ...
            <InformeRow
              tienda="4584"
              franquiciado="LOGUERCIO GIULIANO FRANCO"
              cuit="20-45689393-0"
              referencia="AC384MD"
              tipo="Certificado de dominio"
              estado="EN CURSO"
              status="curso"
            />
            ...
            <InformeRow
              tienda="0001"
              franquiciado="COLORES MARIA JOSE"
              cuit="27-32652653-8"
              referencia="DNI 32652653"
              tipo="Anotaciones personales"
              estado="ENTREGADO"
              status="entregado"
            />
            ...
            <InformeRow
              tienda="4500"
              franquiciado="MARTINEZ JUAN ANTONIO"
              cuit="20-24608694-5"
              referencia="CUIT 20246086945"
              tipo="Índice de titularidad"
              estado="EN CURSO"
              status="curso"
            />
          </section>
...
function InformeRow({ tienda, franquiciado, cuit, referencia, tipo, estado, status }) {
  const badgeStyle =
    status === "observado"
      ? badgeWarningStyle
      : status === "entregado"
  ...
  return (
    <div style={tableRowStyle}>
      ...
      <Link href="/dia/informes/1" style={detailButtonStyle}>
        Ver detalle
      </Link>
    </div>
  );
